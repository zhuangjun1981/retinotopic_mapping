...
indicator=Indicator(mon)
KS_stim=stim.KSstim(mon,indicator,coordinate='linear',sweep_frame=1, flicker_frame=100)
display_iter = 2
# print (len(KSstim.generate_frames())*display_iter)/float(mon.refresh_rate)
ds=DisplaySequence(log_dir=r'C:\data',backupdir=r'C:\data',is_triggered=False,display_iter=2,display_screen=1)
ds.set_stim(KS_stim)
ds.trigger_display()
plt.show()
#==============================================================================================================================
...
#indicator=Indicator(mon)
#flashing_circle=stim.FlashingCircle(mon,indicator, radius=20., flash_frame=200)
#display_iter = 2
...
#indicator=Indicator(mon)
#sparse_noise=SparseNoise(mon,indicator, subregion=(-20.,20.,40.,60.), grid_space=(10, 10), background=0., sign='ON')
...
#                          postgap_dur=3.,
#                          midgap_dur=1.)
#ds = DisplaySequence(log_dir=r'C:\data', backupdir=None, display_iter=1, is_triggered=False, is_sync_pulse_pulse=True,
